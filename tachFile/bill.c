...
void xemHoaDon(HoaDon danhSachHoaDon[], int soHoaDon) {
    ...
    for (int i = 0; i < soHoaDon; i++) {
        ...
        printf("Diem tich luy    : %.2f\n", danhSachHoaDon[i].khachHang.diemTichLuy);
        printf("So dien thoai    : %s\n", danhSachHoaDon[i].khachHang.soDienThoai);
        printf("Ngay nhap don    : %02d/%02d/%04d\n", 
               danhSachHoaDon[i].ngayNhapDon.ngay, 
               danhSachHoaDon[i].ngayNhapDon.thang, 
               danhSachHoaDon[i].ngayNhapDon.nam);
        printf("----------------------------------------------------------------------\n");
        ...
        for (int j = 0; j < danhSachHoaDon[i].soMonGoi; j++) {
            printf("%-5d %-20s %-10d %-10.2f %-10.2f\n", 
                   j + 1, 
                   danhSachHoaDon[i].tenMonGoi[j], 
                   danhSachHoaDon[i].soLuongMon[j], 
                   danhSachHoaDon[i].giaMonGoi[j], 
                   danhSachHoaDon[i].soLuongMon[j] * danhSachHoaDon[i].giaMonGoi[j]);
        }
        printf("----------------------------------------------------------------------\n");
        printf("%-36s %-10s %-10.2f\n", "", "TONG TIEN:", danhSachHoaDon[i].tongTien);
        printf("%-36s %-10s %-10.2f\n", "", "TIEN THUA:", danhSachHoaDon[i].tienThua);
        printf("======================================================================\n\n");
    }
}
